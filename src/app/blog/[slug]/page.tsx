      ...
      <article className="mx-auto w-full max-w-4xl px-3 py-6 sm:px-6 sm:py-12">
        ...
        <div className="grid gap-6 lg:gap-12 lg:grid-cols-[1fr_220px]">
          <div className="min-w-0">
            ...
            <div className="prose dark:prose-invert max-w-3xl prose-headings:font-semibold prose-headings:tracking-tight prose-h2:mt-8 prose-h2:mb-4 sm:prose-h2:mt-10 sm:prose-h2:mb-6 prose-h2:text-xl sm:prose-h2:text-2xl prose-h3:text-lg sm:prose-h3:text-xl prose-p:text-sm sm:prose-p:text-base prose-p:leading-7 sm:prose-p:leading-8 prose-li:text-sm sm:prose-li:text-base prose-li:leading-6 sm:prose-li:leading-7 prose-ul:my-4 prose-ol:my-4 prose-li:my-2 prose-code:font-mono prose-code:text-xs sm:prose-code:text-sm dark:prose-code:text-xs prose-pre:my-4 sm:prose-pre:my-6 prose-pre:p-3 sm:prose-pre:p-4 prose-pre:bg-card prose-pre:border prose-pre:border-border prose-pre:text-xs sm:prose-pre:text-sm prose-pre:overflow-x-auto dark:prose-a:text-primary dark:hover:prose-a:text-primary/80 dark:prose-strong:text-foreground">
              <MDXRemote
                source={post.content}
                options={{
                  mdxOptions: {
